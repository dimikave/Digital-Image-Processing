...
function nCutValue = calculateNcut(anAffinityMat, clusterIdx)
    ...
    % We are going to take clusterIdx with values 1 and 2 (k = 2) 
    % so we seperate the clusters to c1 and c2 according to their value,
    % creating two vectors of flags containing the indices of nodes.
    % Then we will pass these flags as affinityMatrix indices to calculate
    % assoc.
